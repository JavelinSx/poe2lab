...
- **Внизу слева** — «✉ сообщить о нестыковке» (отзыв автору со скринами и открытым билдом), «Тексты игры: русские ✓» (если английские — нажми, там объяснение и кнопка исправить),
