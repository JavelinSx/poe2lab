...
- **Внизу слева** — «⚒ журнал крафта» (статистика выпадения модов для настоящих весов, см. [руководство](../GUIDE.md)), «✉ сообщить о нестыковке» (отзыв автору со скринами и открытым билдом), «Тексты игры: русские ✓» (если английские — нажми, там объяснение и кнопка исправить),
