...
const I18N = {
  ru: {
    ...
    psNoAscSub: "Возвышение выбирается после первого испытания восхождения. Ниже — возвышения твоего класса: PoB примерил каждую их значимую ноду на твоём билде. «Оценка» — сумма четырёх лучших нод (на 8 очков обычно берут около четырёх). 0 значит не «бесполезно», а «PoB не видит эффекта» — тогда решай по описанию и меткам. На схеме дерева в режиме «возвышение» видны все варианты.",
  ...
  en: {
    ...
    psNoAscSub: "The ascendancy is chosen after the first trial of ascension. Below are your class's ascendancies: PoB tried each of their notables on your build. \"Worth\" is the sum of the four best notables (8 points usually buy about four). 0 does not mean useless but \"PoB sees no effect\": then judge by the text and chips. The tree view's ascendancy mode shows them all.",
