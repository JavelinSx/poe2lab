...
const I18N = {
  ru: {
    ...
    trSearch: "Искать",
    trNote: "Ищутся только продавцы онлайн — им можно написать и купить сразу. Поиск идёт через pathofexile.com/trade — теми же запросами, что делает сама страница торговли: 2–4 запроса на слот, с паузами по лимитам сайта. Покупаешь сам — на сайте или в игре.",
    ...
    trRelaxed: "Со всеми модами сразу ничего нет — показаны вещи, где не хватает одного.",
  ...
  en: {
    ...
    trSearch: "Search",
    trNote: "Only sellers online now are searched: you can message them and buy at once. The search goes through pathofexile.com/trade, with the same requests its own page makes: 2 to 4 per slot, paced by the site's limits. You buy it yourself, on the site or in game.",
    ...
    trRelaxed: "Nothing has all of them at once: these miss one.",
