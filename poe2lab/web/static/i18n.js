...
const I18N = {
  ru: {
    ...
    trSearch: "Искать",
    trNote: "Поиск идёт через pathofexile.com/trade — теми же запросами, что делает сама страница торговли: 2–4 запроса на слот, с паузами по лимитам сайта. Покупаешь сам — на сайте или в игре.",
  ...
  en: {
    ...
    trSearch: "Search",
    trNote: "The search goes through pathofexile.com/trade, with the same requests its own page makes: 2 to 4 per slot, paced by the site's limits. You buy it yourself, on the site or in game.",
