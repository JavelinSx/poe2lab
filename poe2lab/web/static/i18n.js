...
const I18N = {
  ru: {
    ...
    crLoading: "Проигрываю способы крафта…", crNeed: "Нужно целевых модов:", crNeedN: (n) => `${n}`,
    ...
    crWeightsNote: "Веса модов в PoE2 скрыты игрой: здесь все тиры считаются равновероятными, поэтому шансы — оценка. Порядок способов обычно верный, точные цифры — нет. «Невезение» — 9 из 10 игроков уложатся в эту цифру.",
  ...
  en: {
    ...
    crLoading: "Playing out the crafting methods…", crNeed: "Target mods needed:", crNeedN: (n) => `${n}`,
    ...
    crWeightsNote: "PoE2 hides mod weights: every tier counts as equally likely here, so the chances are estimates. The order of the methods is usually right, the exact numbers are not. \"Bad luck\": 9 of 10 players finish within it.",
