...
const I18N = {
  ru: {
    ...
    crTargets: (need, n) => `Цель — ${need} из ${n} модов, самых ценных для билда (в верхних тирах для этого уровня предмета):`,
    ...
    crStrategy_magic_omens: "То же, с предзнаменованиями стороны",
    crStrategy_essence: "Эссенция → возвышения",
    crStrategy_essence_omens: "Эссенция → возвышения с предзнаменованиями",
    ...
    crStep_regal_omens: "{0} — вещь становится редкой. Если цели не хватает только на одной стороне — вместе с {1} (префикс) или {2} (суффикс).",
    crStep_regal: "{0} — вещь становится редкой.",
    crStep_exalt_omens: "{0} вместе с {1} (префикс) или {2} (суффикс) — на ту сторону, где цель ещё не закрыта. Пока не будет нужное число целевых модов или 6 модов. Шанс это не повышает, зато неудачная база видна раньше — меньше возвышений впустую.",
    ...
    crStep_desecrate: "Если не хватает одного целевого мода, а место есть: {0} (осквернение; с {1} или {2} — на нужную сторону). При раскрытии выбери нужный мод из трёх.",
  ...
  en: {
    ...
    crIlvl: "Item level:",
    crTargets: (need, n) => `Goal: ${need} of these ${n} mods, the most valuable for the build (top tiers for this item level):`,
    ...
    crStrategy_magic_omens: "The same, with side omens",
    crStrategy_essence: "Essence → exalts",
    crStrategy_essence_omens: "Essence → exalts with omens",
    ...
    crStep_regal_omens: "{0}: the item becomes rare. If targets are missing on one side only, together with {1} (prefix) or {2} (suffix).",
    crStep_regal: "{0}: the item becomes rare.",
    crStep_exalt_omens: "{0} with {1} (prefix) or {2} (suffix), towards the side still missing a target, until the item has enough target mods or 6 mods. It does not raise the chance, but a dud shows sooner: fewer exalts wasted.",
    ...
    crStep_desecrate: "If one target mod is missing and there is room: {0} (desecration; with {1} or {2} for the side). On reveal, pick the right mod of the three.",
