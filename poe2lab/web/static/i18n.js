...
const I18N = {
  ru: {
    ...
    unNote: "Цифры — если надеть вместо того, что сейчас в этом слоте: минус часто значит, что текущая вещь сильнее по статам, а уник ценен механикой. Строки «PoB не считает» в цифры не входят.",
  ...
  en: {
    ...
    unNote: "Numbers are for wearing it instead of what is in that slot now: a minus often means the current item has better stats while the unique is worth its mechanic. Lines PoB does not count are not in the numbers.",
