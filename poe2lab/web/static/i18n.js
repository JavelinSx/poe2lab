...
const I18N = {
  ru: {
    ...
    jnRule3: "После каждой сферы наведи на вещь и нажми Ctrl+Alt+C (с Alt видны тиры и стороны модов). Копируй все вещи подряд, не только удачные — иначе веса исказятся.",
  ...
  en: {
    ...
    jnRule3: "After each orb hover the item and press Ctrl+Alt+C (with Alt the mods' tiers and sides show). Copy every item, not only the good ones, or the weights come out skewed.",
