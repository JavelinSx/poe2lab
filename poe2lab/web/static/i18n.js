...
const I18N = {
  ru: {
    ...
    jnRule2: "Крафти обычными сферами: превращение, усиление, царская, возвышение, алхимия, хаос. Без эссенций, костей, предзнаменований и больших/совершенных сфер — с ними моды выпадают не свободно.",
    ...
    jnStatsTitle: "Сколько набрано",
    jnStats: (n, d) => `Записей: ${n}, проб: ${d}.`,
    jnClass: "Тип предмета",
    jnRecords: "Вещей",
    jnDraws: "Проб",
    jnNoDraws: "Проб пока нет.",
    jnHowMany: "Проба — один случайно выпавший мод. Для одного типа предмета ориентир — 500–1000 проб: редкое семейство модов (≈2% выпадений) оценится примерно с точностью ±30%. Здоровье, сопротивления и прочие общие моды учатся на всех базах сразу.",
  ...
  en: {
    ...
    jnRule2: "Craft with the regular orbs: transmutation, augmentation, regal, exalted, alchemy, chaos. No essences, bones, omens or greater/perfect orbs: with them mods do not roll freely.",
    ...
    jnStatsTitle: "Collected so far",
    jnClass: "Item class",
    jnRecords: "Items",
    jnDraws: "Draws",
    jnNoDraws: "No draws yet.",
    jnHowMany: "A draw is one mod that rolled at random. For one item class aim for 500–1000 draws: a rare mod family (≈2% of rolls) then comes within about ±30%. Life, resistances and other shared mods learn from every base at once.",
