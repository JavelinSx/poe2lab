...
const I18N = {
  ru: {
    ...
    crWeightsNote: "Веса модов в PoE2 скрыты игрой. Здесь, как в PoE1, верхние тиры реже нижних: вес тира падает вдвое на каждые 25 уровней мода (тир 80-го уровня примерно в 9 раз реже тира 1-го). Это допущение, поэтому шансы — оценка: порядок способов обычно верный, точные цифры — нет. «Невезение» — 9 из 10 игроков уложатся в эту цифру.",
  ...
  en: {
    ...
    crWeightsNote: "PoE2 hides mod weights. Here, as in PoE1, high tiers are rarer than low ones: a tier's weight halves every 25 mod levels (a level 80 tier is about 9x rarer than a level 1 one). This is an assumption, so the chances are estimates: the order of the methods is usually right, the exact numbers are not. \"Bad luck\": 9 of 10 players finish within it.",
