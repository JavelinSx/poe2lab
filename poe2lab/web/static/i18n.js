...
const I18N = {
  ru: {
    ...
    psTaken: "Взятые значимые и ключевые пассивки",
    psTakenSub: (p, n) => `Потрачено очков пассивок: ${p}. Значимых и ключевых нод: ${n}; малые ноды (характеристики, проценты) — на схеме дерева.`,
    psGrowth: "Лучшие варианты роста (до 6 очков)",
    psGrowthSub: "Ноды, которые больше всего дадут на очко, с дорогой к ним. На схеме дерева они зелёные.",
    psToTree: "Все варианты, перераспределение и план — вкладка «Дерево»",
  ...
  en: {
    ...
    psTaken: "Allocated notables and keystones",
    psTakenSub: (p, n) => `Passive points spent: ${p}. Notables and keystones: ${n}; small nodes (attributes, percentages) are on the tree view.`,
    psGrowth: "Best growth options (up to 6 points)",
    psGrowthSub: "The nodes that give most per point, with the road to them. Green on the tree view.",
    psToTree: "Every option, respec and the plan: the Tree tab",
