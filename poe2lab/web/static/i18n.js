...
const I18N = {
  ru: {
    ...
    hitsNote: "Число — самый сильный удар монстра (до модификаторов карты), который ты переживаешь с полного здоровья. Полоска — доля от лучшего значения в таблице.",
  ...
  en: {
    ...
    hitsNote: "The number is the largest monster hit (before map mods) you survive from full life. The bar is its share of the best value in the table.",
