...
const I18N = {
  ru: {
    ...
    jnWeightsSub: "Расчёт начинает с допущения крафта (моды одинаковы; у брони и бижутерии тиры равны, у оружия вес тира падает вдвое каждые 50 уровней) и сдвигает его по записанным пробам. Пока проб мало, веса почти не меняются.",
  ...
  en: {
    ...
    jnWeightsSub: "The estimate starts from crafting's assumption (mods alike; armour and jewellery tiers alike, a weapon tier's weight halving every 50 levels) and moves it by the recorded draws. With few draws the weights hardly change.",
    ...
    crWeightsNote: "PoE2 does not show mod weights. By the craft journal (1285 draws) the tiers of a mod roll equally often on armour and jewellery, the top one as often as the rest, while on weapons high tiers are rarer (half the weight every 50 levels); mods differ (life, resistances about 2.5x the average). That is how it counts here, with mods alike, so the chances are estimates; \"Apply to crafting\" in the journal refines the mods' weights. \"Bad luck\": 9 of 10 players finish within it.",
