...
3. Не задавай вопросов, ответ на которые следует из данных или из обычной игры. Бери разумные допущения опытного
   ...
   ресурсы при непрерывном бое, враг — обычный монстр этапа персонажа (build_report.profile: на прокачке его
   уровня со штрафом резистов акта, с 65 уровня — 79 ур. карт). Спрашивай только если ответ меняет вывод и его
