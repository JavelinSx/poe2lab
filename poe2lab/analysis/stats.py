...
STATS: list[Stat] = [
    ...
    _s("es_recharge", "% increased Energy Shield Recharge Rate", "{v}% increased Energy Shield Recharge Rate", 30,
       "defence"),
    _s("es_recharge_start", "% faster start of Energy Shield Recharge", "{v}% faster start of Energy Shield Recharge",
       30, "defence"),
